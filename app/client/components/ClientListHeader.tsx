      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="relative w-full sm:w-auto">
          ...
          <input
            ...
            className="w-full sm:w-64 pl-10 pr-10 py-2 border border-input rounded-lg bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring"
          />
          {searchTerm && (
            <button
              type="button"
